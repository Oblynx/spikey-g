...
scatterhist(trainSet(:,2),trainSet(:,5),'Group',classLabels, 'Location','SouthEast',...
  'Direction','out','Color','br','Marker','ox','MarkerSize',5);
title('log frq for both peaks'); xlabel('log frq1'); ylabel('log frq2');
figure;
