...
%               
% Outputs:      Zica is an (n x r) matrix containing the r independent
...
[Zcw T] = whiten(center(Z));

Zcw= Zcw';  % for compatibility with the rest of the function
